...
fn daffodil_explicit_length_suite() {
    ...
    for name in [
        ...
        "ExplicitLengthBitsFixed",
        "ExplicitLengthBitsNotFixed",
        "ExplicitLengthBytesFixed50",
        "ExplicitLengthCharsFixed",
        "ExplicitLengthCharsNotFixed",
        "denseBit_lengthKind_explicit",
        "explicitBytes_int_01",
        "explicitBytes_int_02",
        "explicitBytes_string_01",
        "inRangeLengthBinaryInteger1",
        "inRangeLengthBinaryInteger2",
        "inRangeLengthBinaryInteger6",
        "inRangeLengthBinaryInteger7",
        "inRangeLengthBinaryInteger10",
        ...
        "outOfRangeLengthBinaryDecimal5",
        ...
        "outOfRangeLengthBinaryInteger8",
        "outOfRangeLengthBinaryInteger9",
        "test_ExplicitLengthBytesBroken",
        "test_ExplicitLengthBytesChoiceRef",
        "test_ExplicitLengthBytesFixed",
        "test_ExplicitLengthBytesNotFixed",
        "test_ExplicitLengthBytesNotGiven",
        "test_ExplicitLengthChildLengthLessParent_Bytes",
        "test_ExplicitLengthChildLengthLessParent_Chars",
...
fn daffodil_section12_pattern_extended_suite() {
    ...
    for name in [
        ...
        "LengthPatternIllegalBits_02_EncodingErrorPolicy_Error",
