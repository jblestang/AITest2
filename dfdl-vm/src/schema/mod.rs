...
pub(crate) use parser::{
    format_ref_qname_for_diag, lookup_named_format_in_document, merge_dfdl_props,
};
...
pub use entities::{
    ...
    delimited_terminator_expression_uses_es_literal, eval_runtime_delimiter_expression,
